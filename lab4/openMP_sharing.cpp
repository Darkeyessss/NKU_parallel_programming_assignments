...
void ParallelGaussianEliminationFalseSharing()
{
    // 设置线程数
    ...
    {
        float value;
        char padding[64 - sizeof(float)]; // Assuming cache line size is 64 bytes
    } tmp;
...
int main()
{
    ...
    ParallelGaussianEliminationFalseSharing();
